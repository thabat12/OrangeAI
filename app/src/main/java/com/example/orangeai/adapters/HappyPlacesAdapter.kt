...
open class HappyPlacesAdapter(
    ...
    open var list: ArrayList<ActivityPrograms>
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.setOnClickListener {
                ...
                if (onClickListener != null) {
                    ...
                    holder.itemView.iv_selected_unselected.setImageResource(R.drawable.ic_baseline_add_circle_24)
